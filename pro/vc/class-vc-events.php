	...
	public function openwp_vc_openagenda_element() {
		...
		$params = array(
			...
			array(
				...
				'description' => __( 'URL to Agenda. You must create a page integrating OpenAgenda', 'wp-openagenda-pro' ),
				'admin_label' => false,
				'weight'      => 0,
				'group'       => __( 'Settings', 'wp-openagenda-pro' ),
			),
			...
			array(
				...
				'heading'     => __( 'language to display', 'wp-openagenda-pro' ),
				'param_name'  => 'lang',
			...
			array(
				...
				'param_name'  => 'nb_event',
				'value'       => '1',
				'description' => __( 'Number of event to display', 'wp-openagenda-pro' ),
				'admin_label' => false,
				'weight'      => 0,
				'group'       => __( 'Settings', 'wp-openagenda-pro' ),
			),
