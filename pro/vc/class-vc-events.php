	...
	public function openwp_vc_openagenda_element() {
		...
		$params = array(
			...
			array(
				...
				'holder'      => 'a',
				'class'       => 'url-class',
				'heading'     => __( 'Internal URL of Main Agenda Page:', 'wp-openagenda-pro' ),
				'param_name'  => 'agenda_url',
				'value'       => esc_url( site_url() ),
				'description' => __( 'Internal URL of Main Agenda Page. You must create a page integrating OpenAgenda', 'wp-openagenda-pro' ),
				'admin_label' => false,
				'weight'      => 0,
				'group'       => __( 'Settings', 'wp-openagenda-pro' ),
			),
			...
			array(
				...
				'heading'     => __( 'Languages of events:', 'wp-openagenda-pro' ),
				'param_name'  => 'lang',
				'description' => __( 'Choose the lang to display.', 'wp-openagenda-pro' ),
				'admin_label' => false,
				'value'       => '',
				'weight'      => 0,
				'group'       => __( 'Settings', 'wp-openagenda-pro' ),
			...
			array(
				...
				'holder'      => 'p',
				'class'       => 'title-class',
				'heading'     => __( 'Nb of event', 'wp-openagenda-pro' ),
				'param_name'  => 'nb_event',
				'value'       => '1',
		...
		vc_map( array(
				'name'        => __( 'Event Openagenda', 'wp-openagenda-pro' ),
				'base'        => 'openwp-vc-basic',
				'description' => __( 'Display Event from Openagenda', 'wp-openagenda-pro' ),
